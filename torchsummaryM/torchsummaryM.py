...
if __name__ == "__main__":
    ...
    inp = torch.Tensor(16, 1, 28, 28)
    inp2 = torch.Tensor(16, 1).long()
    inp3 = torch.zeros((16, 2, 3)).float()
    summary(Net(), inp, inp2)
    ...
    test_z = torch.zeros((64, 784)).float()
    test_label = torch.zeros((64, )).long()

    summary(Discriminator(), test_z, test_label)